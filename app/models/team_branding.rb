...
# Per-team branding customization for push delivery pages. Supports custom
# logo (attached via ActiveStorage), colors, heading/message/footer text,
# and optional white-label mode. One record per team.
# Requires Settings.enable_user_branding and Settings.enable_teams.
