...
Rails.application.configure do
  ...
  # Covers common private / non-routable IPv4 ranges (RFC 1918, loopback,
  # link-local, RFC 6598) so typical Docker and LAN reverse proxies are
  # trusted without extra config. This matters for accurate client-IP
  # detection used by IP allowlisting and geofencing. See GH #4289.
